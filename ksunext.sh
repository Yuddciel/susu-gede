...
CLANG="AOSP Clang"
CODENAME="[A12]"
ZIPNAME="Michael-KSUNEXT-$(date '+%Y%m%d-%H%M').zip"
CAPTION="A12 Kernel $PHONE Compile Complete"
BOT_TOKEN="7485743487:AAEKPw9ubSKZKit9BDHfNJSTWcWax4STUZs"
CHAT_ID="-1002354747626"
MESSAGE="🚀 Build For A12 Started"
MESSAGE_ERROR="Error Build For A12 Aborted"
